...
(function() {
    ...
    Window_ItemTraits.prototype.drawValue = function() {
        ...
        var bitmap = ImageManager.loadSystem(price);
        var bitmap = ImageManager.loadSystem(price);
        var x = 240;
        var y = 7;
        var pw = 165;
	...
	Scene_Item.prototype.createCategoryWindow = function() {
	    ...
	    this._categoryWindow.x = 280;
	    this._categoryWindow.y = 127;
	...
	Scene_Item.prototype.createTraitsWindow = function() {
		...
		this._traitsWindow.x = 397;
	    this._traitsWindow.y = 170;
		this._helpWindow.width = 420;
	    this._helpWindow.height = 148;
	    this._traitsWindow.opacity = 255;
